...
const Register = ({ mode }: { mode: Mode }) => {
  ...
  const langData  = multiLanguagesData[0]?.value;
  return (
    ...
    <div className='flex flex-col justify-center items-center min-bs-[100dvh] relative p-6'>
      <Card className='flex flex-col sm:is-[450px]'>
        <CardContent className='p-6 sm:!p-12'>
          ...
          {/* <Typography variant='h4'>Journey starts here 🚀</Typography> */}
          <Typography variant='h4'> {(langData?.register_heading)?langData?.register_heading:"Get started your journey"} </Typography>
          <div className='flex flex-col gap-5'>
            {/* <Typography className='mbs-1'>Make your app management easy and fun!</Typography> */}
            <Registration multi_lang={multiLanguagesData} />
