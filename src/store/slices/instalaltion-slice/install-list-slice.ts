...
// import { fetchinstallationlist } from "../../../services/api/installation-api/get-installation-list";

// export const fetchinstallDataThunk: any = createAsyncThunk(
//   'installData/fetchinstallDataThunk',
//   async (token: any) => {
//     const installationData = await fetchinstallationlist(token);
...
//     builder.addCase(fetchinstallDataThunk.pending, (state) => {
//       state.isLoading = 'pending';
//       state.partyName = '';
//       state.items = [];
//     });
//     builder.addCase(fetchinstallDataThunk.fulfilled, (state, action) => {
//       console.log(
...
//       }
//     });
//     builder.addCase(fetchinstallDataThunk.rejected, (state, action) => {
//       state.isLoading = 'failed';
//       state.partyName = '';
//       state.items = [];
