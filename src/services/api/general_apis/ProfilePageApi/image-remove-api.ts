...
const ProfileImageRemove = async (request: any, token: any) => {
  let response: any;
...
const ProfileImageRemoveApi = (request: any, token: any) => ProfileImageRemove(request, token);

export default ProfileImageRemoveApi;
