...
import { fetchpermissionmodule, submit_addroles , get_roleby_name} from "../../services/api/roles/roles-api";
...
import RoleDetailTabs from "./Detail/RoleDetailTabs";
...
const RoleDetails: any = (slug) => {
    ...
    const role_name = slug?.role_name;
    ...
    useEffect(() => {
        ...
        const getroledata: any = async () => {
          ...
          const getroleData: any = await get_roleby_name(
            { "rolename": role_name }, userToken?.access_token,
          );
    ...
    <>
      <Grid
        ...
        style={{ padding: "0px" }}
      >
         <RoleDetailTabs customerData={roledata} />       
      </Grid>
    </>
  );
    ...
    // return (
    //     <>
    //         <form className='flex flex-col gap-5 mbe-5'>
    ...
    //                             <Typography variant='h5'>{(selectedMultiLangData?.view_role) ? selectedMultiLangData?.view_role : "View Role"}</Typography>
    //                         </div>
    //                             <>
    ...
    //                                                 <i className="ri-edit-box-line text-primary text-[22px]" />
    //                                                 <Typography className='font-bold' color='secondary' component={Link} href={`/roles/edit/` + roledata.role_name} >Edit</Typography>
    //                                             </div>
    //                                         </>
    //                                     ):(null)}
    ...
    //                                                     <Typography className="font-bold text-1xl">Role name </Typography>
    //                                                 </div>
    //                                                 <div className="flex items-center gap-1">
    //                                                     <Typography className="font-bold text-1xl">Role Description </Typography>
    //                                                 </div>
    //                                                 <div className="flex items-center gap-1">
    //                                                     <Typography className="font-bold text-1xl">{selectedMultiLangData?.lbl_role_data_share ? selectedMultiLangData?.role_data_share : "Share Data with Peers"}</Typography>
    //                                                 </div>
    //                                             </div>
    //                                         </Grid>
    ...
    //                                             <div className="flex flex-col gap-3">
    //                                                 <div className="flex items-center gap-1">
    //                                                     <Typography>{roledata?.role_name}</Typography>
    //                                                 </div>
    //                                                 <div className="flex items-center gap-1">
    //                                                     <Typography>{roledata?.role_description}</Typography>
    //                                                 </div>
    //                                                 <div className="flex items-center gap-1">
    //                                                     <Checkbox id="data_share" disabled checked={roledata?.share_data_with_peers == 1 ? true: false} /><Tooltip title="By default, users with the same role cannot view each other's data. However, if Share Data with Peers is enabled for a role, then users with that role can see each other's data." placement="top" style={{ fontSize: "28px" }}><InfoOutlinedIcon color="success" /></Tooltip>
    //                                                 </div>
    //                                             </div>
    //                                         </Grid>
    //                                     </Grid>
    ...
    //                                                     <TableHead>
    //                                                         <TableRow>
    //                                                             <TableCell width={"15%"}>Module</TableCell>
    ...
    //                                                                                                                             <TableCell width="5%" component="td" > <Checkbox disabled id={`permission.${historyRow?.order_sequence}.full_access `} checked={historyRow?.full_access}  onChange={handleChange} /></TableCell>
    //                                                                                                                             <TableCell width="5%" component="td"> <Checkbox disabled id={`permission.${historyRow?.order_sequence}.view `} checked={historyRow?.view}  onChange={handleChange} /></TableCell>
    //                                                                                                                             <TableCell width="5%" component="td"> <Checkbox disabled id={`permission.${historyRow?.order_sequence}.create `} checked={historyRow?.create}  onChange={handleChange} /></TableCell>
    //                                                                                                                             <TableCell width="5%" component="td"> <Checkbox disabled id={`permission.${historyRow?.order_sequence}.edit `} checked={historyRow?.edit}  onChange={handleChange} /></TableCell>
    //                                                                                                                             <TableCell width="5%" component="td"> <Checkbox disabled id={`permission.${historyRow?.order_sequence}.delete `} checked={historyRow?.delete}  onChange={handleChange} /></TableCell>
    //                                                                                                                             <TableCell width="5%" component="td"> <Checkbox disabled id={`permission.${historyRow?.order_sequence}.print `} checked={historyRow?.print}  onChange={handleChange} /></TableCell>
    //                                                                                                                             <TableCell width="5%" component="td"> <Checkbox disabled id={`permission.${historyRow?.order_sequence}.cimport `} checked={historyRow?.cimport}  onChange={handleChange} /></TableCell>
    //                                                                                                                             <TableCell width="5%" component="td"> <Checkbox disabled id={`permission.${historyRow?.order_sequence}.export `} checked={historyRow?.export}  onChange={handleChange} /></TableCell>
    //                                                                                                                             <TableCell width="5%" component="td"> <Checkbox disabled id={`permission.${historyRow?.order_sequence}.email `} checked={historyRow?.email}  onChange={handleChange} /></TableCell>
    //                                                                                                                         </TableRow>
    //                                                                                                                     ): (null)}
    //                                                                                                                 </>
    //                                                                                                             ))}
    ...
    //                                                                                                 <TableCell  style={{ width: '15%', color: "#616161" }} component="td" >{data?.frontend_module}</TableCell>
    //                                                                                                 <TableCell width="5%" component="td" > <Checkbox disabled id={`permission.${data?.order_sequence}.full_access `} checked={data?.full_access}  onChange={handleChange} /></TableCell>
    //                                                                                                 <TableCell width="5%" component="td"> <Checkbox disabled id={`permission.${data?.order_sequence}.view `} checked={data?.view}  onChange={handleChange} /></TableCell>
    //                                                                                                 <TableCell width="5%" component="td"> <Checkbox disabled id={`permission.${data?.order_sequence}.create `} checked={data?.create}  onChange={handleChange} /></TableCell>
    //                                                                                                 <TableCell width="5%" component="td"> <Checkbox disabled id={`permission.${data?.order_sequence}.edit `} checked={data?.edit}  onChange={handleChange} /></TableCell>
    //                                                                                                 <TableCell width="5%" component="td"> <Checkbox disabled id={`permission.${data?.order_sequence}.delete `} checked={data?.delete}  onChange={handleChange} /></TableCell>
    //                                                                                                 <TableCell width="5%" component="td"> <Checkbox disabled id={`permission.${data?.order_sequence}.print `} checked={data?.print}  onChange={handleChange} /></TableCell>
    //                                                                                                 <TableCell width="5%" component="td"> <Checkbox disabled id={`permission.${data?.order_sequence}.cimport `} checked={data?.cimport}  onChange={handleChange} /></TableCell>
    //                                                                                                 <TableCell width="5%" component="td"> <Checkbox disabled id={`permission.${data?.order_sequence}.export `} checked={data?.export}  onChange={handleChange} /></TableCell>
    //                                                                                                 <TableCell width="5%" component="td"> <Checkbox disabled id={`permission.${data?.order_sequence}.email `} checked={data?.email}  onChange={handleChange} /></TableCell>
    //                                                                                             </TableRow>    
    //                                                                                         </TableCell>
    //                                                                                     </TableRow>
    //                                                                                 </>
